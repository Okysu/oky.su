...
<template>
  <div class="relative group" v-on-click-outside="closeMenu">
    <button
      ...
      class="p-2 lg:p-2.5 rounded-full glass cursor-pointer transition-all duration-300
    ...
    >
      <div v-show="isOpen" class="absolute right-0 mt-2 w-32 rounded-xl glass-card py-2 px-1.5 z-50 shadow-xl border border-gray-200/50 dark:border-gray-700/50 flex flex-col gap-1">
        <button
